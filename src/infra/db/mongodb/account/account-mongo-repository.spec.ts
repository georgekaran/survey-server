...
import { mockAddAccounParams } from '@/domain/test'
...
describe('Account Mongo Repository', () => {
  ...
  describe('loadByEmail()', () => {
    test('Should return an account on loadByEmail success', async () => {
      ...
      await accountCollection.insertOne(mockAddAccounParams())
  ...
  describe('updateAccessToken()', () => {
    test('Should update the account acessToken on updateAccessToken success', async () => {
      ...
      const res = await accountCollection.insertOne(mockAddAccounParams())
