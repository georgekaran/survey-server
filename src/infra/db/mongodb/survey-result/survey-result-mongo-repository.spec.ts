...
describe('Survey Mongo Repository', () => {
  ...
  describe('loadBySurveyId()', () => {
    test('Should load survey result', async () => {
      ...
      expect(surveyResult.answers[0].isCurrentAccountAnswer).toEqual(true)
      expect(surveyResult.answers[1].count).toBe(0)
      expect(surveyResult.answers[1].percent).toBe(0)
      expect(surveyResult.answers[1].isCurrentAccountAnswer).toEqual(false)
    })
    ...
    test('Should load survey result 2', async () => {
      ...
      expect(surveyResult.surveyId).toEqual(survey.id)
      expect(surveyResult.answers[0].count).toEqual(2)
      expect(surveyResult.answers[0].percent).toEqual(67)
      expect(surveyResult.answers[0].isCurrentAccountAnswer).toEqual(true)
    ...
    test('Should load survey result 3', async () => {
      ...
      expect(surveyResult.answers[0].isCurrentAccountAnswer).toEqual(false)
      expect(surveyResult.answers[1].count).toBe(1)
